...
def fit(seqs_train,cnf_iters, x_dim=3, bin_width=20.0, min_var_frac=0.01, em_tol=1.0E-8,
    ...
    max_iters=em_max_iters, tol=em_tol, freq_ll=freq_ll, verbose=verbose, cnf=cnf, cnf_lr=cnf_lr,cnf_iters=cnf_iters)
...
def em(params_init, seqs_train, device,max_iters=500, tol=1.0E-8, min_var_frac=0.01,
       freq_ll=5, verbose=False, cnf = None, cnf_lr=.1,cnf_iters=50):
    """
