...
from elephant.gpfa import nggpfa_core_seq as nggpfa_core
...
class NGGPFA_SEQ(sklearn.base.BaseEstimator):
    r"""
    ...
    def __init__(self, bin_size=20 * pq.ms, x_dim=3, min_var_frac=0.01,
                 ...
                 em_max_iters=500, freq_ll=5, verbose=False, cnf_lr = .01,device='cpu',cnf_iters=500):
        # Initialize object
        self.cnf_iters= cnf_iters
